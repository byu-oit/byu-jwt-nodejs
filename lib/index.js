...
function ByuJWT (options) {
  ...
  if (!Object.hasOwnProperty.call(options, 'host')) {
    options.host = 'api.byu.edu'
  }
  if (!Object.hasOwnProperty.call(options, 'openIdConfigUrl')) {
    const host = /^https?:\/\//.test(options.host) ? options.host : `https://${options.host}`
    options.openIdConfigUrl = `${host}/.well-known/openid-configuration`
  }
